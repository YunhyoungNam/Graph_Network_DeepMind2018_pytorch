# -*- coding: utf-8 -*-
"""
Created on Thu Aug 25 15:58:49 2022
...
#def create_data(rand, batch_size, num_nodes_min_max, theta, input_ph,
#                     target_ph):
def create_data(rand, batch_size, num_nodes_min_max, theta):    
